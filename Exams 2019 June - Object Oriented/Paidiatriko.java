 ...
 * @author user
 */
public class Paidiatriko extends Kliniki implements iPaidiatriko{
    
    private double exodaXeirourgiou;

    public Paidiatriko(double exodaXeirourgiou, String onomaKlinikis, int tmima, int typosTherapeias, double kostosEpiskepsis, int typosDwmatiou, int meresTherapeias) {
