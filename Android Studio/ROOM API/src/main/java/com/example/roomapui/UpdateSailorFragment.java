 ...
 */
public class UpdateSailorFragment extends Fragment {

    EditText editText1,editText2,editText3,editText4;
    Button submitButton;

    public UpdateSailorFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_sailor, container, false);
        ...
        submitButton = view.findViewById(R.id.update_sailor_button);
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    MainActivity.myAppDatabase.myDao().updateSailor(sailors);
